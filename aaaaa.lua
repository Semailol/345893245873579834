if getgenv().Credit == 'Ticxyy stand, discord.gg/utFYVgpAqv' then
    ...
    local ScriptName = "zezi stand"
    if getgenv().StandLoaded ~= nil then
        Notify({Title = "stand has been ran already nigga",Duration = 5})
        return
    end
    ...
    while benxed do
        local hummy = stand.Character.Humanoid
        pcall(function()
        ...
        stand.HumanoidRootPart.CFrame =
            stand.HumanoidRootPart.CFrame + stand.HumanoidRootPart.CFrame.lookVector * 0.5

        stand.HumanoidRootPart.Velocity =
            stand.HumanoidRootPart.CFrame.lookVector * 70

        wait(0.1)

        stand.HumanoidRootPart.Velocity =
            stand.HumanoidRootPart.CFrame.lookVector * -200
    end
end
