...
wait(1)
StandOwner = getgenv().XKang.Owner
Pos = getgenv().XKang.Position
CrewID = getgenv().XKang.CrewID
Attack = getgenv().XKang.Attack
StandMode = getgenv().XKang.StandMode
FlyMode = getgenv().XKang.FlyMode
Prediction = getgenv().XKang.Prediction
gunkillprediction = getgenv().XKang.GunPrediction
CustomName = getgenv().XKang.CustomName
AutoMask = getgenv().XKang.AutoMask
ChatCmds = getgenv().XKang.ChatCmds
AttackMode = getgenv().XKang.AttackMode
GunMode = getgenv().XKang.GunMode
SummonPose = getgenv().XKang.SummonPose
PosingType = getgenv().XKang.Posing
Hidescreen = getgenv().XKang.Hidescreen
Smoothing = getgenv().XKang.Smoothing
Sounds = getgenv().XKang.Sounds
SummonMusic = getgenv().XKang.SummonMusic
VanishAppear = getgenv().XKang.VanishAppearSound
CustomSong = getgenv().XKang.CustomSong
resolve = getgenv().XKang.Resolver
Bind = getgenv().XKang.AntiStomp
Fpscap = getgenv().XKang.FPSCAP
lowgraphics = getgenv().XKang.LowGraphics
Alt = getgenv().XKang.Alt
getgenv().__ = 'Lynix'
getgenv().___ = 'Ticxyy'
